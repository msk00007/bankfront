    ...
    <div className="landing-page">
      ...
      <section className="landing-content">
        <div className="content-section">
          <h2>About Us</h2>
          <p>At ABC Bank, we are dedicated to providing the highest quality of banking services to our customers. With over 20 years of experience in the industry, we offer a range of services including personal and business banking, loans, and investment solutions tailored to your needs.</p>
        </div>
        <div className="content-section">
          <h2>Our Services</h2>
          <ul>
